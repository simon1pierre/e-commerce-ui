    ...
    <div className="shadow-lg rounded-lg overflow-hidden">
      {/* Image */}
        ...
        <div className="relative aspect-[2/3]">
          <Image  src={product.images[produtTypes.color]} fill alt={product.name} className="object-cover hover:scale-105 transition-all duration-300" />
        </div>
        </Link>
        {/* Product details */}
            ...
            <div className="flex flex-col gap-1">
              ...
              <div className="flex items-center gap-2 ">
                {product.colors.map(color=>(
                  <div key={color} className={`cursor-pointer border-1 ${produtTypes.color === color? "border-gray-400" : "border-gray-200"} rounded-full p-[2px]`} onClick={()=>handleProductType({type:"color", value:color})}>
